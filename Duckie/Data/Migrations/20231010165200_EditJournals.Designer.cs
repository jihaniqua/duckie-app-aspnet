...
namespace Duckie.Data.Migrations
{
    ...
    [Migration("20231010165200_EditJournals")]
    partial class EditJournals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Duckie.Models.ChildProfile", b =>
                {
                    b.Property<int>("ChildProfileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ChildProfileId"));
            ...
            modelBuilder.Entity("Duckie.Models.Journal", b =>
                {
            ...
            modelBuilder.Entity("Duckie.Models.Milestone", b =>
                {
            ...
            modelBuilder.Entity("Duckie.Models.Journal", b =>
                {
                    b.HasOne("Duckie.Models.ChildProfile", "ChildProfile")
                        .WithMany()
